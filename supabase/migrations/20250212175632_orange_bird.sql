/*
  ...
  1. Changes
    - Drop existing files column and recreate it as JSONB
    - Add proper triggers for file handling
...
-- Drop and recreate files column
ALTER TABLE tasks 
...
CREATE POLICY "task_files_upload_policy"
ON storage.objects
FOR INSERT
TO authenticated
WITH CHECK (bucket_id = 'task-attachments');

CREATE POLICY "task_files_read_policy"
ON storage.objects
FOR SELECT
TO public
